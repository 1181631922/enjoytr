...
public class GuideActivity extends Activity implements OnTouchListener{
    ...
    private void initViewPager() {
    	...
    	listView.add(inflater.inflate(R.layout.activity_lay1, null));
    	listView.add(inflater.inflate(R.layout.activity_lay2, null));
    	listView.add(inflater.inflate(R.layout.activity_lay3, null));
    	listView.add(inflater.inflate(R.layout.activity_lay4, null));
