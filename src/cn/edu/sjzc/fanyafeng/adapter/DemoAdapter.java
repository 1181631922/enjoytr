...
public class DemoAdapter extends BaseAdapter {
	 ...
	 * 数据集合
	 */
	private List<MyCollegeBean> datas = null;
	...
	public DemoAdapter(Context context, List<MyCollegeBean> datas) {
		this.datas = datas;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		MyCollegeBean bean = datas.get(position);
	 ...
	 * 增加一项的时候
	 */
	public void add(MyCollegeBean bean) {
	...
	public List<MyCollegeBean> getDatas() {
		return datas;
	}
